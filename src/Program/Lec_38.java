...
public class Lec_38 {
    public static void main(String[] args) {
        ...
        Employee38 Harry = new Employee38();        // Initilizing new Employee Object
        Harry.Id = 1;                           // Setting attributes
        Harry.Name = "CodeWithHarry";
        Harry.Salary = 12000;

        Employee38 Tejas = new Employee38();        // Initilizing new Employee Object
        Tejas.Id = 2;                           // Setting attributes
        Tejas.Name = "CodeWithTejas";
        Tejas.Salary = 13000;

        Employee38 Vaibhav = new Employee38();      // Initilizing new Employee Object
