...
// -- 1) If we declare static function then we can access it directally by using Class_Name as well as by creating object.
// -- 2) If we not declare function as static then need to create object of class to access it only.
...
public class Lec_31 {
    ...
    public static void main(String[] args) {
        ...
        // By Creating Object
        Lec_31 a1 = new Lec_31();
        a1.Greet();                      // Hello from Base Class

        // Directlly by Using Class Name
        Lec_31.Greet();                  // Hello from Base Class
        ...
        // By Creating Object
        Lec_31 a2 = new Lec_31();
        a2.Greet();                 // Hello from Base Class

        // Directlly by Using Class Name
        Lec_31.Greet();             // Error - Cannot make a static reference to the non-static method
