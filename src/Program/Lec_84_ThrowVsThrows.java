...
class Radius_Negative_Exception extends Exception {
    ...
    @Override
    public String getMessage() {
        return "Negative Radius NOY Possible";
    }
}

public class Lec_84_ThrowVsThrows {
    ...
    public void main(String[] args) {
        ...
        int age = sc2.nextInt();
        Lec_84_ThrowVsThrows a = new Lec_84_ThrowVsThrows();
        ...
        Lec_84_ThrowVsThrows b = new Lec_84_ThrowVsThrows();
