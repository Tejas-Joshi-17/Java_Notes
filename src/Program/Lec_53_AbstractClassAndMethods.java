 ...
 *  2) Abstract Class = Class which contains atleast one Abstract Method.
 *  3) Concrete Method = Method which is declare as well as define.
 *  4) Concrete Class = Class which contains all methods as concrete.
 *
 *  1) One Abstract Method makes whole class as Abstract Class.
 *  2) Abstract Class can contains many Concrete Methods, but it contains atleast one Abstract Method
 *  3) Using Abstract Class we can create another class.
 *  4) Abstract Class is Standard Class.
 *  5) We can't create object of Abstract Class.
 *  6) Until all methods of Abstract Class is define we can't create Concrete Class
 ...
 *  10) We can't create object of class until it is Concrete.
 *
...
public class Lec_53_AbstractClassAndMethods {
    public static void main(String[] args) {

        // Abstract Class = Parent531, Child531
        // Concrete Class = Child532, Child533
