...
class Parent_Class_1 {
    Parent_Class_1() {
        System.out.println("Parent Class with No. of Argument - 0");
    }

    Parent_Class_1(int a) {
        System.out.println("Parent Class with No. of Argument - 1");
    }

    Parent_Class_1(int a, int b) {
        System.out.println("Parent Class with No. of Argument - 2");
    }
}
...
public class this_vs_super extends Parent_Class_1 {
    ...
    public static void main(String[] args) {
        ...
        // Parent Class with No. of Argument - 0
        // Self Class with No. of Argument - 0

        this_vs_super b = new this_vs_super(10);
        // Parent Class with No. of Argument - 2
